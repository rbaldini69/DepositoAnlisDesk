...
namespace DepositoAnlisClases
{
    public static class Constantes
    {
        public const string ordenCompra = "Número Orden de compra:";
        public const string procedimientoTipo = "Tipo:";
        public const string procedimientoNro = "Descripción:";
        public const string procedimientoNroReemplazar = "Orden de compra generada por Proceso Nº ";
        public const string procedimientoAnio = "Ejercicio:";
        public const string fecha = "Fecha ﬁnalización:";
        public const string expediente = "Número expediente:";
        public const string adjudicatarioNombre = "Razón social:";
        ...
        public const string inicioRenglon = "unitario Moneda Total Acciones";
