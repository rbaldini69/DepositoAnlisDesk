...
Public Class FrmConsultaRecepciones
    ...
    Private Sub CargaOCs()
        ...
        Try
            ...
            For Each dr As DataRow In dt.Rows
                ...
                i = i + 1
                CboOCs.Items.Add(sRight("0000" + LTrim(Str(dr.Item(0))), 5) + " - " & dr.Item(1) & " - " & dr.Item(2))
                'DestCods(i) = dr.Item(0)
    ...
    Private Sub GeneraConsulta()
        ...
        Try
            strSQL = "SELECT CASE WHEN N.Tipo IS Null Then 'OC' Else N.Tipo END Tipo,NroNotaPedido Nro,i.NroIr,CodProducto Codigo,i.DescProducto Descripcion, Cantidad"
            strSQL = strSQL & ",u.Descripcion as Unidad"
            strSQL = strSQL & ",Convert(Date,i.[FechaRecep]) Fecha, ic.NroIR_Constancia Constancia,NroRemito ,d.DestDesc As Destinatario,ic.DestCod"
            ...
            If CboOCs.SelectedIndex > 0 Then
                ...
                strWHERE = strWHERE & "NroNotaPedido=" & Mid(CboOCs.Text, 1, 5)
                '    'End If
            End If
            ...
            If Len(strWHERE) > 0 Then strWHERE = strWHERE & " AND "
            strWHERE = strWHERE & " convert(date,i.FechaRecep)>=convert(date,'" & DTPFechaD.Value & "') AND convert(date,i.FechaRecep)<=convert(date,'" & DTPFechaH.Value & "')"
    ...
    Private Sub GeneraConsultaPendiente()
        ...
        Try
            ...
            If CboOCs.SelectedIndex > 0 Then
                If Len(strWHERE) > 0 Then strWHERE = strWHERE & " AND "
                strWHERE = strWHERE & "NotaPedido=" & Mid(CboOCs.Text, 1, 5)
                '    'End If
            End If
