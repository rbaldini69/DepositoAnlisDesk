...
Public Class RptInvertario01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DepositoAnlis.RptInvertario01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInvertario01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInvertario01 = New RptInvertario01()
        rpt.Site = Me.Site
        Return rpt
    End Function
