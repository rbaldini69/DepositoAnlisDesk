...
Public Class rptAjustesDeStock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DepositoAnlis.rptAjustesDeStock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAjustesDeStock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAjustesDeStock = New rptAjustesDeStock()
        rpt.Site = Me.Site
        Return rpt
    End Function
