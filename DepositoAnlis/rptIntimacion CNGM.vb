...
Public Class rptIntimacion_CNGM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DepositoAnlis.rptIntimacion CNGM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIntimacion_CNGM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIntimacion_CNGM = New rptIntimacion_CNGM()
        rpt.Site = Me.Site
        Return rpt
    End Function
