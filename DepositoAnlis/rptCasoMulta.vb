...
Public Class rptCasoMulta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DepositoAnlis.rptCasoMulta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCasoMulta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCasoMulta = New rptCasoMulta()
        rpt.Site = Me.Site
        Return rpt
    End Function
