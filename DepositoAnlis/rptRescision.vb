...
Public Class rptRescision
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DepositoAnlis.rptRescision.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRescision
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRescision = New rptRescision()
        rpt.Site = Me.Site
        Return rpt
    End Function
