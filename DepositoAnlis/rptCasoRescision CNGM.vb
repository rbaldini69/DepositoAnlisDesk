...
Public Class rptCasoRescision_CNGM
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCasoRescision CNGM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DepositoAnlis.rptCasoRescision CNGM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdRescision() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_numPedido() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCasoRescision_CNGM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCasoRescision_CNGM = New rptCasoRescision_CNGM()
        rpt.Site = Me.Site
        Return rpt
    End Function
