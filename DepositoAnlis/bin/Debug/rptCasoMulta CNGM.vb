...
Public Class rptCasoMulta_CNGM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DepositoAnlis.rptCasoMulta CNGM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdCasoMulta() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCasoMulta_CNGM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCasoMulta_CNGM = New rptCasoMulta_CNGM()
        rpt.Site = Me.Site
        Return rpt
    End Function
