...
Public Class rptActaRecepDefinitiva_CNGM
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptActaRecepDefinitiva CNGM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DepositoAnlis.rptActaRecepDefinitiva CNGM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IrConstancia() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NroConstanciaIR() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptActaRecepDefinitiva_CNGM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptActaRecepDefinitiva_CNGM = New rptActaRecepDefinitiva_CNGM()
        rpt.Site = Me.Site
        Return rpt
    End Function
