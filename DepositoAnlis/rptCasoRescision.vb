...
Public Class rptCasoRescision
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DepositoAnlis.rptCasoRescision.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCasoRescision
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCasoRescision = New rptCasoRescision()
        rpt.Site = Me.Site
        Return rpt
    End Function
