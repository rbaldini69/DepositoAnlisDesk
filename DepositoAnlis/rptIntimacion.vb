...
Public Class rptIntimacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DepositoAnlis.rptIntimacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIntimacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIntimacion = New rptIntimacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
